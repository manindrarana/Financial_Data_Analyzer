...
* **Volatility Clustering:** When we plotted the *absolute* returns, the line decayed slowly. We learned this proves "Volatility Clustering" (big price swings happen in groups).
